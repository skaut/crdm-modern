...
const SAFE = {
	...
	/*
	 * Notes 1, 2 and 3 are height properties, `stretch` (Firefox wants
	 * `-moz-available`) and `flex-basis`. Intrinsic values only ever reach
	 * `width` here, including the prefixed copies Lightning CSS generates.
	 */
